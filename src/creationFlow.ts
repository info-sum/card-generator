...
export const AUTO_TEMPLATE_OPTIONS: readonly TemplateOption[] = [
  ...
  },
  {
    ...
    layout: 'split-light',
    title: '밝은 분할',
    description: '밝은 배경에서 이미지와 텍스트를 나눠 보여주는 레이아웃',
    accent: '#0f8a8d',
  },
  {
    id: 'auto-split-dark',
    ...
    layout: 'split-dark',
    title: '다크 분할',
    description: '짙은 배경 대비로 제목을 강하게 보여주는 레이아웃',
    accent: '#1c2b42',
  },
  {
    id: 'auto-sequence',
...
export const DIRECT_TEMPLATE_OPTIONS: readonly TemplateOption[] = [
  ...
  },
  {
    ...
    layout: 'split-light',
    title: '밝은 분할',
    description: '본문과 이미지를 밝은 톤으로 나눠 편집하는 레이아웃',
    accent: '#0f8a8d',
  },
  {
    ...
    layout: 'split-dark',
    title: '다크 분할',
    description: '강한 대비로 제목을 돋보이게 하는 레이아웃',
    accent: '#1c2b42',
  },
  {
    id: 'manual-sequence',
